...
/**
* Plugin Name: LinkMyDeals - Clipper Upload
* Plugin URI: http://linkmydeals.com/clipper-plugin.php
* Description: LinkMyDeals.com provides Coupon & Deal Feeds from 4000+ Online Stores. You can use this plugin to automate/upload the feeds into your Clipper Installation.
* Version: 2.7
